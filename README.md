...
commentary constitution and its companions (ONTOLOGY, ATTACHMENT_MODEL,
PROVENANCE_LAYERS, INTERPRETIVE_BOUNDARIES, SCHEMA_SKETCH, PROTOTYPE,
LIFECYCLE, VERSIONING, MIGRATION, REPAIR_PROTOCOLS); CITATION_PERMANENCE,
PUBLIC_PRIVATE_BOUNDARIES, AI_STEWARDSHIP_POLICY,
