...
|---|---:|---|
| Index entries (web app reader) | **1,212** | `03_web_app/data/_generated/index.json` (entry count) |
| — of which public | **1,120** | same (`restricted` ≠ true) |
...
| Distinct ids | 1,121 | unique `id` — 33 ids legitimately shared across 124 entries (Jātaka ×8, bilingual pairs, multi-volume works) |
