...
|---|---:|---|
| Index entries (web app reader) | **1,218** | `03_web_app/data/_generated/index.json` (entry count) |
| — of which public | **1,126** | same (`restricted` ≠ true) |
...
| Distinct ids | 1,127 | unique `id` — 33 ids legitimately shared across 124 entries (Jātaka ×8, bilingual pairs, multi-volume works) |
...
growth to 1,126 public entries and will be recounted at the next
validation run.)
