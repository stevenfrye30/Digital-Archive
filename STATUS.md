...
| — of which public | **973** | same (`restricted` ≠ true) — 2026-08-17: −2, the title-collision withdrawals (sacred-tree = Waley's Genji Part Two, PD 2037, identity corrected to `genji-sacred-tree_waley`; buddhas-life-olcott = the withdrawn Herold/Blum body re-served under a false credit, PD 2052) |
| — of which restricted (locked, metadata-only) | **139** | same (`restricted` = true) — incl. nostradamus-roberts (uncertain-copyright, withdrawn 2026-07-28: body does not match its stated Ward 1891 source) |
