...
| — of which public | **974** | same (`restricted` ≠ true) — 2026-08-17: −1, the title-collision withdrawal (the body served as `sacred-tree-philpot` is Waley's Genji Part Two, PG #67111; Waley d. 1966 → PD 2037; identity corrected to `genji-sacred-tree_waley` with the old route aliased) |
| — of which restricted (locked, metadata-only) | **138** | same (`restricted` = true) — incl. nostradamus-roberts (uncertain-copyright, withdrawn 2026-07-28: body does not match its stated Ward 1891 source) |
