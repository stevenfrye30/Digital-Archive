...
|---|---:|---|
| Index entries (web app reader) | **1,177** | `03_web_app/data/_generated/index.json` (entry count) — 2026-08-07: +5 derived Shakespeare play work records (Much Ado, Troilus, Timon, 2H4, King John; provider `shakespeare-complete-plays`) |
| — of which public | **1,062** | same (`restricted` ≠ true) |
| — of which restricted (locked, metadata-only) | **115** | same (`restricted` = true) — incl. nostradamus-roberts (uncertain-copyright, withdrawn 2026-07-28: body does not match its stated Ward 1891 source) |
