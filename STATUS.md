...
|---|---:|---|
| Index entries (web app reader) | **1,108** | `03_web_app/data/_generated/index.json` (entry count) — 2026-08-20: −1, the folklore ruling (flat duplicate retired after its footnote apparatus was ported to the finalized witness) — 2026-08-07: +5 derived Shakespeare play work records (Much Ado, Troilus, Timon, 2H4, King John; provider `shakespeare-complete-plays`) |
| — of which public | **957** | same (`restricted` ≠ true) — 2026-08-20: −3, the gospel exposures withdrawn (truth/mary/thomas → restricted, the Peshitta grammar) — 2026-08-20: −1, the folklore flat duplicate (scope cut, superseded_by folklore-holy-land-hanauer; its 171-note apparatus ported first) — 2026-08-20: −1, the barlaam/mattingly withdrawal (the 1914 Loeb; Mattingly d. 1964, PD 2035; no excision seam) — after 2026-08-18: −6, THE SIX (Giles PD 2029 behind Lyall; Baerlein PD 2031 behind Nicholson; Bentwich PD 2042 behind Conybeare; Isenberg 1977 served beside its restricted siblings; Breed 1948 open-dated behind 'Cheeseman 1915'; O'Bryan 1956 BAE, worldwide bar unresolved) — after the 08-17 title-collision three (Genji/Waley, Herold-Blum/Olcott, Fyfe/Tacitus) |
| — of which restricted (locked, metadata-only) | **151** | same (`restricted` = true) — incl. nostradamus-roberts (uncertain-copyright, withdrawn 2026-07-28: body does not match its stated Ward 1891 source) |
