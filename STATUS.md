...
|---|---:|---|
| Index entries (web app reader) | **1,179** | `03_web_app/data/_generated/index.json` (entry count) — 2026-08-07: +5 derived Shakespeare play work records (Much Ado, Troilus, Timon, 2H4, King John; provider `shakespeare-complete-plays`) |
| — of which public | **1,057** | same (`restricted` ≠ true) |
