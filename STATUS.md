...
| — of which public | **975** | same (`restricted` ≠ true) — 2026-08-17: −3, the last-mile exposures withdrawn (oedipus, Murray d. 1957 → PD 2028; ginzberg-legends vols 3–4, Radin d. 1959 → PD 2030 — both hidden behind wrong-person translator credits) |
| — of which restricted (locked, metadata-only) | **137** | same (`restricted` = true) — incl. nostradamus-roberts (uncertain-copyright, withdrawn 2026-07-28: body does not match its stated Ward 1891 source) |
