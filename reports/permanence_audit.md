...
Aliased passage URN redirects through the test alias table to the actual passage 1.3; the alias chain is preserved in the response. Re-anchored 2026-08-10 from 1.62, which was a sacred-texts.com running head that a correct cleanup removed on 2026-06-08 — a fixture must anchor to text the archive would defend, not to page furniture. 1.3 carries two approved commentary glosses.
